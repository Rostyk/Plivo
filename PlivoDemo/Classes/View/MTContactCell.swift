...
class MTContactCell: UITableViewCell {
    ...
    func updateInitialsColorForIndexPath(_ indexpath: IndexPath) {
        ...
        let colorArray = [MTGlobalConstants.Colors.amethystColor, MTGlobalConstants.Colors.asbestosColor, MTGlobalConstants.Colors.emeraldColor, MTGlobalConstants.Colors.peterRiverColor, MTGlobalConstants.Colors.pomegranateColor, MTGlobalConstants.Colors.pumpkinColor, MTGlobalConstants.Colors.sunflowerColor]
    ...
    func updateContactsinUI(_ contact: MTContact, indexPath: IndexPath, subtitleType: SubtitleCellValue) {
    ...
    func updateSubtitleBasedonType(_ subtitleType: SubtitleCellValue, contact: MTContact) {
        ...
        case SubtitleCellValue.phoneNumber:
            ...
            if phoneNumberCount == 1 {
                ...
                self.contactDetailTextLabel.text = MTGlobalConstants.Strings.phoneNumberNotAvaialable
            }
        case SubtitleCellValue.email:
            ...
            if emailCount == 1 {
                ...
                self.contactDetailTextLabel.text = MTGlobalConstants.Strings.emailNotAvaialable
            }
